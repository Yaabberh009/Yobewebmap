...
map.getView().fit([965452.366239, 1175107.234249, 1503475.658484, 1511253.596978], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Yobe State Healthcare Facilities Map</h2>';
        return titleElement;
    })(),
