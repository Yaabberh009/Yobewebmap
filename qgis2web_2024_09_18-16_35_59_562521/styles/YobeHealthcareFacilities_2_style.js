var size = 0;
var placement = 'point';
function categories_YobeHealthcareFacilities_2(feature, value, size, resolution, labelText,
        ...
        image: new ol.style.Circle({radius: 2.76924 + size,
            stroke: new ol.style.Stroke({color: 'rgba(227,26,28,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(241,108,91,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case 'Tertiary':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 11.2 + size, points: 4,
...
var style_YobeHealthcareFacilities_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_YobeHealthcareFacilities_2(feature, value, size, resolution, labelText,
